...
export const addInventoryItem = createAction(`${prefix} add inventory item`, props<InventoryItem>());
export const removeInventoryItem = createAction(`${prefix} remove inventory item`, props<Pick<InventoryItem, 'id'>>());
export const updateInventoryItem = createAction(`${prefix} update inventory item`, props<Update<InventoryItem>>());
